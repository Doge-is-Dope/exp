...
Describe the purpose in one sentence. Keep requirements, constraints, and acceptance results in [SPEC.md](SPEC.md).

## Run

After selecting a stack, add installation, configuration, and startup commands. This template does not contain an executable application yet.
